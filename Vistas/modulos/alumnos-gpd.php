...
include __DIR__ . "/../../Modelos/tabla.php";
...
<div class="content-wrapper">
    ...
    <section class="content DT" style="overflow-x: auto;">
        <div class="box container">
            ...
            <!-- tabla -->
            <table id="tablaArticulos" class="table mx-auto">
         
        <table id="dtHorizontalVerticalExample" class="table table-striped table-bordered table-sm DT" cellspacing="0"
            width="100%">
            <thead>
                <tr>
                    <th>N°</th>
...
<div class="modal fade" rol="dialog" id="EditarAlumno">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="post" role="form" id="formNotes">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control input-lg" id="fechacontratoE" name="fechacontrato"
                                required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control input-lg" id="fechaintroE" name="fechaintroE"
                                required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control input-lg" id="horasautorizadasE"
                                name="horasautorizadasE" required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control input-lg" id="nuevoplazoE" name="nuevoplazoE"
                                required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control input-lg" id="fechavencimientoE"
                                name="fechavencimientoE" required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control input-lg" id="observacionesE" name="observacionesE"
                                required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control input-lg" id="fechanacimientoE"
                                name="fechanacimientoE" required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control input-lg" id="telefonocasaE" name="telefonocasaE"
                                required>
